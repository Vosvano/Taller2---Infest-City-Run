...
public class BuildingsSpawner2 : MonoBehaviour
{
    ...
    public void SpawnBuilding()
    {
        ...
        Quaternion mirrorRotation = Quaternion.Euler(0f, 180f, 0f);

        GameObject building = Instantiate(BuildingPrefab[prefabIndex], spawnPos, mirrorRotation);
